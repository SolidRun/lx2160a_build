...
cp $ROOTDIR/build/rootfs.ext2 $ROOTDIR/images/tmp/
e2mkdir -G 0 -O 0 $ROOTDIR/images/tmp/rootfs.ext2:extlinux
e2cp -G 0 -O 0 $ROOTDIR/images/tmp/extlinux/extlinux.conf $ROOTDIR/images/tmp/rootfs.ext2:extlinux/
e2mkdir -G 0 -O 0 $ROOTDIR/images/tmp/rootfs.ext2:boot
e2cp -G 0 -O 0 $ROOTDIR/images/tmp/boot/Image $ROOTDIR/images/tmp/rootfs.ext2:boot/
e2cp -G 0 -O 0 $ROOTDIR/images/tmp/boot/fsl-lx2160a-cex7.dtb $ROOTDIR/images/tmp/rootfs.ext2:boot/
...
for i in `find lib`; do
	if [ -d $i ]; then
		e2mkdir -G 0 -O 0 $ROOTDIR/images/tmp/rootfs.ext2:usr/$i
	fi
	if [ -f $i ]; then
		DIR=`dirname $i`
		e2cp -G 0 -O 0 -p $ROOTDIR/images/tmp/$i $ROOTDIR/images/tmp/rootfs.ext2:usr/$DIR
	fi
done
cd -
...
cd $ROOTDIR/
e2cp -p -G 0 -O 0 $ROOTDIR/build/restool/install/usr/bin/ls-append-dpl $ROOTDIR/images/tmp/rootfs.ext2:/usr/bin/
e2cp -p -G 0 -O 0 $ROOTDIR/build/restool/install/usr/bin/ls-main $ROOTDIR/images/tmp/rootfs.ext2:/usr/bin/
e2cp -p -G 0 -O 0 $ROOTDIR/build/restool/install/usr/bin/restool $ROOTDIR/images/tmp/rootfs.ext2:/usr/bin/
e2ln images/tmp/rootfs.ext2:/usr/bin/ls-main /usr/bin/ls-addmux
e2ln images/tmp/rootfs.ext2:/usr/bin/ls-main /usr/bin/ls-addni
e2ln images/tmp/rootfs.ext2:/usr/bin/ls-main /usr/bin/ls-addsw
e2ln images/tmp/rootfs.ext2:/usr/bin/ls-main /usr/bin/ls-listmac
e2ln images/tmp/rootfs.ext2:/usr/bin/ls-main /usr/bin/ls-listni
...
dd if=$ROOTDIR/images/tmp/rootfs.ext2 of=$ROOTDIR/images/tmp/ubuntu-core.img bs=1M seek=64 conv=notrunc
